/** @module @convector/convector-tool-chaincode-manager */

import { dirname, join, resolve } from 'path';
import { readFileSync, writeFileSync } from 'fs';
import { copy, emptyDir, mkdirp, ensureDir, writeFile, remove } from 'fs-extra';
import { ClientConfig, ClientHelper } from '@convector/convector-common-fabric-helper';
import { IConfig as ControllersConfig, Config, KV } from '@convector/convector-core-chaincode';

const chaincodePath = dirname(require.resolve('@convector/convector-core-chaincode'));
...
export class Manager extends ClientHelper {
  ...
  public static getCCName(packageName: string): string {
    return packageName.replace(/@convector\//, '');
  }
